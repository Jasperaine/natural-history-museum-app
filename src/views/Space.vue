<template>
    <div class="space-tab">
        <h2 class="space-tab__title">Space highlights</h2>
      ...
      from requesting and rendering potentially 100+ highlights in one go, providing better UX by both speeding
            ...
            >
                ...
                />
                <img v-else src="../assets/orange-star.png" slot="badge" class="card-layout__image" />
            </MuseumHighlight>
        </div>
    </div>
</template>
...
export default {
        ...
        return {
            spaceHighlights: [
                ...
                },
                {
                    ...
                    news: {
                        title:
                            "The Lyrids will peak at on April 21-22 2021, at night"
                    }
                }
            ],
            spacePartners: {
    ...
    methods: {
        formatPartnerHighlights(partnerHighlights) {
            return Object.entries(partnerHighlights).map(
                ([partner, highlight]) => {
                    return {
